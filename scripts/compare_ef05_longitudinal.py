...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Combine E05 and F05 same-well longitudinal pilot metrics into one comparison."
    )
...
def main() -> None:
    ...
    out_dir = pilot_root / "ef05_longitudinal_comparison"
    out_dir.mkdir(parents=True, exist_ok=True)
    csv_path = out_dir / "E05_F05_days_day8_day25_day39_comparison_metrics.csv"
    figure_path = out_dir / "E05_F05_days_day8_day25_day39_comparison_summary.png"
...
def write_comparison_figure(combined: pd.DataFrame, figure_path: Path) -> None:
    ...
    fig.suptitle("E05 reporter control vs F05 primary mCherry longitudinal pilot")
