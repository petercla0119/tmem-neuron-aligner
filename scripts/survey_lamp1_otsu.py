...
print(f"  Rationale: median of non-KO conditions; KO Otsu is expected lower due to dim LAMP1.")
...
# Save survey
out = Path("/Users/pmihack/claire/tmem_2026/tmem-if-features/reports/if_segmentation_pilot")
